package com.thanos.common.crypto.paillier;
...
/**
 * 类PaillierTest.java的实现描述：
 *
 * @Author laiyiyu create on 2019-12-24 10:32:06
 */
public class PaillierTest {
    public static void test1() {
        ...
        String c4 = PaillierCipher.ciphertextAdd(c1,c2);
        System.out.println("c3.length:"+c3.length());
        System.out.println("c3:"+c3);

        BigInteger o4 = PaillierCipher.decrypt(c3, priKey1);
        System.out.println("o3:"+o3);
    }
